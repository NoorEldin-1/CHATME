  ...
  return (
    <div className="overflow-hidden w-full h-16 bg-black/25 backdrop-blur-lg flex items-center justify-between relative text-white border-b border-white/25 p-4">
      ...
      <div className="flex gap-2">
        <div className="relative cursor-pointer duration-300 hover:[&>svg]:text-yellow-600 hover:scale-95">
        ...
        <LuUserSearch className="text-blue-600 text-3xl cursor-pointer duration-300 hover:text-blue-900 hover:scale-95" />
        <IoMdSettings className="text-3xl cursor-pointer duration-300 hover:text-white/50 hover:scale-95" />
      </div>
    </div>
  );
});
